...
var dj = {
	...
	startMusic: function (name){
		...
		audio.addEventListener('canplaythrough', function(){
			window.top.postMessage('ready','http://5.lucienfeel.sinaapp.com/onlineDJ/index.html');
		},false)
		//绑定播放完停止
		audio.addEventListener('ended', function(){
			stop = 1;
			window.top.postMessage('stop','http://5.lucienfeel.sinaapp.com/onlineDJ/index.html');
		},false)
	}
	//控制区域事件
	,control: function(){
